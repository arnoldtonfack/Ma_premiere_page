...
const LastProducts = () => {
  return (
    <Container>
      <div className= 'grid   md:grid-cols-2 gap-3 md:gap-9 w-full h-96 my-19  lg:px-11 my-20 uppercase text-white'>
        <div className='bg-primary relative   p-5 md:p-7  md:row-span-2 rounded md:h-full '>
        ...
        <div className='z-10 relative'>
            ...
            <span className='text-xl md:text-2xl font-black'>Burger le plus populaire</span>
          </div>
        </div>
        <div className='bg-primary relative p-5 md:p-7 h-full rounded'>
        ...
        <div className='z-10 relative'>
            ...
            <span className='text-xl md:text-2xl font-black'>plus de gout</span>
          </div>
        </div>
        <div className='bg-primary relative p-5 md:p-7 h-full rounded'>
        ...
        <div className='z-10 relative'>
            ...
            <span className='text-xl md:text-2xl font-black'>frais & pimente</span>
          </div>
        </div>
      </div>
